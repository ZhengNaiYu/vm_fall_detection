...
python train_pose_sequence.py --config config_improved.yaml
```
...
1. **训练曲线图** - `improved_train_hist_cls9_fps10.png`
   - Loss应该平滑下降
...
# 编辑 config_improved.yaml，设置 type: "Transformer"
python train_pose_sequence.py --config config_improved.yaml
